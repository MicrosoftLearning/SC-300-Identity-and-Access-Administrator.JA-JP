...
1. 制限付き管理者ディレクトリ ロール、ゲスト招待元ロール、またはグローバル管理者に割り当てられたユーザーとして、**Microsoft Entra 管理センター** (**`https://entra.microsoft.com`** ) にサインインします。

1. 左側にあるナビゲーションで、**[Entra ID]** の下にある **[ユーザー]** を選択し、**[すべてのユーザー]** を選択します。

1. [ユーザー] ページのメニューで、 **[+ 新しいユーザー]** を選択します。

1. [新しいユーザー] メニューで、 **[外部ユーザーの招待]** を選択してから、ゲスト ユーザーの情報を追加します。
...
1. 電子メール アドレスを入力します (例: `sc300externaluser1@sc300email.com` )。

1. **[プロパティ]** タブを選択します。

1. [ユーザー] ページで、アカウントが一覧表示されていることを確認し、 **[ユーザーの種類]** 列に **[ゲスト]** が表示されていることを確認します。

1. 完了したら、**[確認と招待]**、**[招待]** の順に選択します。

招待を送信すると、ユーザー アカウントがディレクトリにゲストとして自動的に追加されます。

### 演習の概要

この演習では、Microsoft Entra 管理センターを通じて、ゲスト ユーザーをディレクトリに招待しました。 この演習では、外部ユーザーを B2B コラボレーションのために Microsoft Entra ID にオンボーディングする方法を説明しました。
...
1. [ユーザー] ページのメニューで、 **[一括操作]、[一括招待]** の順に選択します。
...
1. [ユーザー一括招待] ページの **[csv ファイルをアップロードします]** で、そのファイルを参照します。
...
1. ジョブの状態を表示するには、 **[各操作の状態を表示するには、ここを選択します]** を選択します。 または、 [アクティビティ] セクションの **[一括操作の結果]** を選択します。 一括操作に含まれる各行の項目の詳細については、 **[成功数]** 、 **[失敗数]** 、 **[要求数合計]** の各列の値を選択してください。 エラーが発生した場合、その理由が表示されます。
...
1. 外部ユーザーを招待する MgInvitation コマンドを送信します。

    ```
    New-MgInvitation -BodyParameter $params
    ```

1. この時点で PowerShell を閉じることができます。
...
この演習では、CSV ファイルをアップロードし、Microsoft Graph PowerShell を実行して、一度に複数のゲスト ユーザーを招待しました。 この演習では、個別の招待を超えて B2B オンボーディングをスケーリングする方法を紹介しました。
