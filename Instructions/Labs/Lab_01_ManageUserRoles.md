...
5. **[パスワードの自動生成]** オプションが選択されていることを確認します。
...
6. **[同意とアクセス許可]**、**[ユーザー設定]** などの他の設定のいずれかを選択して **Chris Green** に権限がないことを確認してください。
...
10. 「ラボで必要」のような正当な理由を入力します。 **[割り当て]** を選択します
...
1. 新しい InPrivate ブラウザー ウィンドウを開きます。
2. Microsoft Entra 管理センター (+++ https://entra.microsoftcom+++) を Chris Green として開きます。
...
3. 画面上部の検索ダイアログで +++「エンタープライズ アプリケーション」+++ を検索して選択します。
4. **[+ 新しいアプリケーション]** が利用可能になったことに注意してください。
5. **[+ 新しいアプリケーション]** を選択します。
6. **[+ 独自のアプリケーションの作成]** が淡色表示されなくなりました。 ギャラリー アプリを選択すると、**[作成]** ボタンが表示されます。

   **注 - このロールには、テナントにアプリケーションを追加する権限があります。この権限については、後のラボでさらに実験します。**

7. ポータルの Chris Green のインスタンスからサインアウトし、ブラウザーを閉じます。
...
2. 検索ボックスに「**ロール**」と入力し **[Microsoft Entra ID のロールと管理]** を起動します。
...
2. Microsoft 365 管理センター (+++https://admin.microsoft.com+++) に接続します。
