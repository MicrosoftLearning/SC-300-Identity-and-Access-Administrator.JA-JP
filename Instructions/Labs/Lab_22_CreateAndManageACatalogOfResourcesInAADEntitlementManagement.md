...
1. 必要に応じて、Microsoft Entra 管理センターで **[ID]** に移動してから、**[ID ガバナンス]**、**[カタログ]**、**[マーケティング]** の順に選択します。
...
1. アクセス レビューでは、アクセス ライフサイクルを管理できます。Microsoft Entra ID ガバナンスには、アクセス レビューの状態を示す概要ダッシュボードが用意されています。 **[Identity Governance]** メニューの **[アクセス レビュー]** を選択します。
...
1. **[レビュー担当者を選択する]** で、これらのレビュー担当者として **[グループ所有者]** を選択します。

  - **注**:ゲスト ユーザーは、適切な ID ガバナンス プラクティスとして自分のアクセス権を確認できないようにする必要があります。
...
1. **[次へ: 確認および作成]**、**[作成]** の順に選択して、新しいアクセス レビューを作成します。
