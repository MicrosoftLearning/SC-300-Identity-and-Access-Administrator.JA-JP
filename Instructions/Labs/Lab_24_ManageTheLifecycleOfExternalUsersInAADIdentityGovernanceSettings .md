...
1. [Microsoft Entra ID] 項目を開き、 **[Identity Governance]** を選択します。

1. 左側のナビゲーション メニューの **[エンタイトルメント管理]** で、**[制御の構成]** を選択します。

1. **外部ユーザーのライフサイクル**というラベルの付いたボックスを見つけます。

1. 上部のメニューで、**[設定の表示]** を選択します。
...
1. **[外部ユーザーのライフサイクル]** セクションで、外部ユーザーに対するさまざまな設定を確認します。
