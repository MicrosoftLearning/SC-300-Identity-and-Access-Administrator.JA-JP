...
1. 左側のナビゲーション メニューで、**[Entra ID]** に移動して **[アプリの登録]** を選択し、**[すべてのアプリケーション]** タブを選択して、前の演習で作成した **[デモ アプリ]** を選択します。

1. **[デモ アプリ]** ページで、各 "**アプリケーション (クライアント) ID**" と "**ディレクトリ (テナント) ID**" の値を見つけて、後で使用できるようにコピーして保存します。
...
1. **[構成されたアクセス許可]** で **[管理者の同意の付与]** を選択します。
...
1. **Microsoft Entra 管理センター**を参照します。

1. 左側のナビゲーション メニューで、**[Entra ID]** の下にある **[エンタープライズ アプリケーション]** を選択します。

1. エンタープライズ アプリケーションの一覧から、先ほど登録した **[デモ アプリ]** を選択します。

1. **[デモ アプリ]** ページの左側のナビゲーションで、 **[セキュリティ]** の下にある **[アクセス許可]** を選択します。
...
この演習では、アプリケーションにテナント全体の管理者の同意を付与しました。 この演習では、管理者がすべてのユーザーに代わってアクセス許可を事前に承認する方法を示しました。
