...
1. [ID] メニューで [**設定 **] メニューを**開き、[Doメイン names] を選択**します**。**
...
1. Microsoft Entra 管理センター内から、[ID **] メニューを**開きます。

1. 左側のナビゲーションで、[概要 **] メニュー項目を選択**し、[プロパティ **] を選択**します。
...
1. [ID] メニューの **** [概要 **] を選択**し、[プロパティ **] を選択**します。
